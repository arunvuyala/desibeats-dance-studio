  ...
  return (
    <section id="about" style={{
      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
        ...
        {/* Header */}
        <div style={{ textAlign: 'center', marginBottom: '3rem' }} ref={ref}>
          <span style={{
          ...
          <h2 style={{
            ...
            fontWeight: '700', color: '#f8f4ee', lineHeight: 1.2, marginBottom: '1.5rem',
          }}>
          ...
          <p style={{
            color: 'rgba(248,244,238,0.65)', maxWidth: '660px', margin: '0 auto',
            fontSize: '1.05rem', lineHeight: 1.9, fontWeight: '300',
          }}>
          ...
          {[
            ...
            >
              ...
              <h3 style={{
                ...
                color: '#f8f4ee', marginBottom: '0.75rem', fontWeight: '600',
              }}>{card.title}</h3>
